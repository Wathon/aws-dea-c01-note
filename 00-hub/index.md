...
1. [[domain-1-ingestion-and-processing]] *(28% Weight)* — Data Ingestion & Transformation Pipelines
2. [[domain-2-data-store-management]] *(26% Weight)* — Storage Systems, Schemas, & Data Warehousing
3. [[domain-3-data-operations-and-support]] *(22% Weight)* — Automation, Monitoring, & Troubleshooting
4. [[domain-4-data-security-and-governance]] *(24% Weight)* — Encryption, IAM, Governance & Compliance
