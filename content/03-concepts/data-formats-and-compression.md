...
- **Language / ဘာသာစကား**: **English (Original)** | [မြန်မာဘာသာ (Burmese)](file:///home/monetine/Workspace/Wathon/aws-dea-c01/content/my/03-concepts/data-formats-and-compression.md)
...
```mermaid
graph TD
    subgraph RowStorage["Row Storage: CSV / JSON / Avro"]
    R1["Row 1: ID, Name, Age, Country"]
    R2["Row 2: ID, Name, Age, Country"]
    end

    subgraph ColumnarStorage["Columnar Storage: Parquet / ORC"]
