...
3. **AWS Cost & Usage Report (CUR)**: The most comprehensive cost dataset available. Delivers hourly or daily granular cost files formatted in CSV/Parquet directly to an S3 bucket for analysis via [[athena]]!
...
## 📌 Related Notes
- [[athena]] — Querying CUR reports with SQL
- [[s3]] — CUR S3 delivery target
