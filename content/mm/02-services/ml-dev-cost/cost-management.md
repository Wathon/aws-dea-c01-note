...
3. **AWS Cost & Usage Report (CUR)**: ရရှိနိုင်သမျှတွင် အပြည့်စုံဆုံးဖြစ်သော cost dataset ဖြစ်သည်။ [[mm/02-services/analytics-streaming/athena/athena|athena]] ဖြင့် ခွဲခြမ်းစိတ်ဖြာနိုင်ရန် နာရီအလိုက် သို့မဟုတ် နေ့အလိုက် အသေးစိတ် granular cost files များကို CSV/Parquet format ဖြင့် S3 bucket ထဲသို့ တိုက်ရိုက် deliver လုပ်ပေးပါသည်။
...
## 📌 Related Notes
- [[mm/02-services/analytics-streaming/athena/athena|athena]] — SQL ဖြင့် CUR reports များကို query လုပ်ခြင်း
- [[mm/02-services/storage/s3/s3|s3]] — CUR S3 delivery target ဖြစ်ခြင်း
